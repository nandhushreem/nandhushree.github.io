(() => {
  ...
  if ($("#heroResume")) { $("#heroResume").href = data.person.resume; $("#heroResume").target = "_blank"; $("#heroResume").rel = "noreferrer"; }
  if ($("#navCta")) { $("#navCta").href = data.person.resume; $("#navCta").target = "_blank"; $("#navCta").rel = "noreferrer"; }
  if ($("#resumeLink")) { $("#resumeLink").href = data.person.resume; $("#resumeLink").target = "_blank"; $("#resumeLink").rel = "noreferrer"; }
